                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row align-items-center">
                                <div class="col-sm-6">
                                    <h3 class="card-title">{{ __('Lesson List') }}</h3>
                                </div>
                                {{-- <span class="badge bg-warning total-count">{{ $grades->total() }}</span> --}}
                                <div class="col-sm-6">
                                    @if (auth()->user()->can('lesson.create'))
                                        <a class="btn btn-primary float-right" href="{{ route('admin.lesson.create') }}">
                        ...
                        {{-- table --}}
                        @include('backends.lesson._table')
...
@push('js')
    ...
    <script>
        ...
        $('input.status').on('change', function() {
            ...
            $.ajax({
                type: "get",
                url: "{{ route('admin.lesson.update_status') }}",
                data: {
                    "id": $(this).data('id')
                },
                dataType: "json",
