                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="tab-content" id="custom-content-below-tabContent">
                                            @foreach (json_decode($language, true) as $lang)
                                                @if ($lang['status'] == 1)
                                                    <?php
                                                    if (count($lesson['translations'])) {
                                                        $translate = [];
                                                        foreach ($lesson['translations'] as $t) {
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group col-md-12">
                                                                ...
                                                                <input type="text" id="title_{{ $lang['code'] }}"
                                                                    ...
                                                                    value="{{ $translate[$lang['code']]['title'] ?? $lesson['title'] }}">
                                    ...
                                    <div class="form-group col-md-12 ">
                                        ...
                                        <select name="category" id="category"
                                            ...
                                            @foreach ($categories as $id => $title)
                                                <option value="{{ $id }}"
                                                    {{ $id == $lesson->category_id ? 'selected' : '' }}>
                                                    {{ $title }}</option>
                                            @endforeach
                                        </select>
                                        @error('category')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    <input type="hidden" name="thumbnail" class="image_names_hidden">
                                            ...
                                            <div class="preview preview-multiple text-center border rounded mt-2"
                                                style="height: 150px">
                                                <img src="{{ asset('uploads/lessons/' . $lesson->thumbnail) }}"
                                                    alt="" height="100%">
                                            </div>
                                        </div>
                                    </div>
